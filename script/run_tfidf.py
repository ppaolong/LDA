...
use_tfidf = True  # Set to False if you don't want to use TF-IDF
if use_tfidf:
    print("Applying TF-IDF transformation...")
    tfidf = TfidfModel(corpus)
    corpus = tfidf[corpus]  # Replace corpus with TF-IDF transformed version
...
plt.grid(True)
plt.savefig('coherence_scores_tfidf.png')
plt.show()
...
final_model = LdaMulticore(corpus=corpus,
                          ...
                          random_state=42,
                          alpha='symmetric')
final_model.save('best_lda_model_tfidf/best_lda_model.model')
...
dictionary.save('best_lda_model_tfidf/dictionary.dict')

# Save corpus
print("Saving corpus...")
MmCorpus.serialize('best_lda_model_tfidf/corpus.mm', corpus)
